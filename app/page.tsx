      ...
      <div className="ek-wrap">
        ...
        <div className="ek-doctor-layout">
          ...
          <motion.div initial={{ opacity: 0, x: -28 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.7, delay: 0.1 }}>
            <div className="ek-photo-placeholder">
              <div className="ek-photo-avatar">👨‍⚕️</div>
              {/* next/image 로 교체하세요: <Image src="/doctor.jpg" alt="원장 사진" fill style={{objectFit:'cover'}} /> */}
              <div className="ek-photo-hint">의료진 사진을 추가해주세요</div>
            </div>
            <div className="ek-doctor-card">
              <div className="ek-doctor-role">원장</div>
              <div className="ek-doctor-name">홍길동 원장</div>{/* ← 실제 성함으로 교체 */}
